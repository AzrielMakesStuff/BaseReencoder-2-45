...
# Running:
To run it with a Java compatable program such as VSCode will be self explanatory, else if you are running it with only the JRE, you need to open A terminal command prompt window and navigate using the cd command to the directory you hava the .java file in, then run:
